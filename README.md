...
A private MCP companion may still exist for partner-specific integrations, but it remains optional alongside the standard hosted surfaces.
...
- Optional private MCP URL for partner-issued connector kits only: `https://mcp.chainrpc.io`
